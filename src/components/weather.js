...
const Weather = (props) => (
    <div className="weather__info">
        {props.data.city && props.data.country && <p className="weather__key">Location    : <span className="weather__value"> {props.data.city} , {props.data.country}</span></p>}
        ...
        {props.data.description && <p className="weather__key">Description :<span className="weather__value">{props.data.description}</span></p>}
